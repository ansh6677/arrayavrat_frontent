...
const ICONS: Record<string, Shape[]> = {
  ...
  tag: [
    { t: 'path', d: 'M3.5 11.4V4.8a1.3 1.3 0 0 1 1.3-1.3h6.6a1.3 1.3 0 0 1 .92.38l8 8a1.3 1.3 0 0 1 0 1.84l-6.6 6.6a1.3 1.3 0 0 1-1.84 0l-8-8a1.3 1.3 0 0 1-.38-.92Z' },
    { t: 'circle', cx: 8, cy: 8, r: 1.5 }
  ],
  percent: [
    { t: 'path', d: 'M18.5 5.5 5.5 18.5' },
    { t: 'circle', cx: 7.8, cy: 7.8, r: 2.6 },
    { t: 'circle', cx: 16.2, cy: 16.2, r: 2.6 }
  ]
};
